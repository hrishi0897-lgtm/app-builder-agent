...
class GeminiManager:
    ...
    def generate_content(self, prompt, system_instruction=None, timeout=60):
        payload = {
            "contents": [
                {
                    "parts": [{"text": prompt}]
    ...
    def generate_with_image(self, prompt, image_bytes, mime_type="image/jpeg", system_instruction=None, timeout=60):
        import base64
